<template>
  ...
  <div
    ...
    <a rel="noopener noreferrer" href="#" class="flex items-center shrink-0 px-5 py-3 space-x-2text-gray-600">
    ...
    <a rel="noopener noreferrer" href="#" class="flex items-center shrink-0 px-5 py-3 space-x-2 text-gray-600">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
        stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4">
        <polygon
